...
def load_model():
    ...
    state_dict = torch.load(r"E:\dataset-CVTC\权重\E-LMCI2(1).pth")
...
def select_target_class():
    ...
    for i, label in enumerate([
        "EarlyMildCognitiveImpairment=0",
        "Health=1",
        "LateMildCognitiveImpairment=2",
        "SignificantMemoryConcern=3"
    ]):
...
# 修改类别提示为新的4类
tk.Label(root, text="类别索引提示:\nEarlyMildCognitiveImpairment=0, Health=1, LateMildCognitiveImpairment=2, SignificantMemoryConcern=3").pack(pady=10)
root.mainloop()