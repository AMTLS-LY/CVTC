...
def select_target_class():
    ...
    # 修改为4个类别
    for i, label in enumerate(["MildDemented=0", "ModerateDemented=1", "NonDemented=2", "VeryMildDemented=3"]):
...
# 修改类别提示为4类
tk.Label(root, text="类别索引提示:\nMildDemented=0, ModerateDemented=1, NonDemented=2, VeryMildDemented=3").pack(pady=10)
root.mainloop()